...
#define FTIR_CLIENT_FILENAME "NPClient.dll"
#define FTIR_VIEWS_FILENAME "TIRViews.dll"
#define FTIR_MM_DATA "{0F98177E-0E5C-4F86-8837-229D19B1701D}"
#define FTIR_MUTEX "FT_TIR_Mutex"
#define FTIR_REGISTER_PROGRAMHANDLE "FT_Register_Program_Handle"
#define FTIR_UNREGISTER_PROGRAMHANDLE "FT_UnRegister_Program_Handle"

#define FTIR_SIG1 "precise head tracking\n put your head into the game\n now go look around\n\n Copyright EyeControl Technologies\0\0";
#define FTIR_SIG2 "hardware camera\n software processing data\n track user movement\n\n Copyright EyeControl Technologies\0\0";
